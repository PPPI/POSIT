...
class CorundumListener(ParseTreeListener):
    ...
    def enterDynamic(self, ctx:CorundumParser.DynamicContext):
        pass

    # Exit a parse tree produced by CorundumParser#dynamic.
    def exitDynamic(self, ctx:CorundumParser.DynamicContext):
        pass
    ...
    def enterId(self, ctx:CorundumParser.IdContext):
        pass

    # Exit a parse tree produced by CorundumParser#id.
    def exitId(self, ctx:CorundumParser.IdContext):
        pass
