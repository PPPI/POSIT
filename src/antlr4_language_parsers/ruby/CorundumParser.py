# Generated from /mnt/d/antlrv4/grammars-v4/ruby/Corundum.g4 by ANTLR 4.7.1
# encoding: utf-8
from antlr4 import *
...
class CorundumParser ( Parser ):
    ...
    def expression_list(self, _p:int=0):
        ...
        try:
            ...
            if token in [CorundumParser.LITERAL, CorundumParser.REQUIRE, CorundumParser.DEF, CorundumParser.RETURN, CorundumParser.PIR, CorundumParser.IF, CorundumParser.UNLESS, CorundumParser.WHILE, CorundumParser.FOR, CorundumParser.TRUE, CorundumParser.FALSE, CorundumParser.BIT_NOT, CorundumParser.NOT, CorundumParser.LEFT_RBRACKET, CorundumParser.NIL, CorundumParser.INT, CorundumParser.FLOAT, CorundumParser.ID, CorundumParser.ID_GLOBAL, CorundumParser.ID_FUNCTION]:
                self.state = 147
                self.expression()
                self.state = 148
                self.terminator(0)
                pass
            elif token in [CorundumParser.SEMICOLON, CorundumParser.CRLF]:
                self.state = 150
                self.terminator(0)
                pass
            else:
    ...
    class Function_nameContext(ParserRuleContext):
        ...
        def id(self):
            return self.getTypedRuleContext(CorundumParser.IdContext,0)
    ...
    def function_name(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [CorundumParser.ID_FUNCTION]:
                self.enterOuterAlt(localctx, 1)
                self.state = 213
                self.id_function()
                pass
            elif token in [CorundumParser.ID]:
                self.enterOuterAlt(localctx, 2)
                self.state = 214
                self.id()
                pass
    ...
    def statement_expression_list(self, _p:int=0):
        ...
        try:
            ...
            if token in [CorundumParser.LITERAL, CorundumParser.REQUIRE, CorundumParser.DEF, CorundumParser.RETURN, CorundumParser.PIR, CorundumParser.IF, CorundumParser.UNLESS, CorundumParser.WHILE, CorundumParser.FOR, CorundumParser.TRUE, CorundumParser.FALSE, CorundumParser.BIT_NOT, CorundumParser.NOT, CorundumParser.LEFT_RBRACKET, CorundumParser.NIL, CorundumParser.INT, CorundumParser.FLOAT, CorundumParser.ID, CorundumParser.ID_GLOBAL, CorundumParser.ID_FUNCTION]:
                ...
                self.terminator(0)
                pass
            elif token in [CorundumParser.RETRY]:
                self.state = 437
                self.match(CorundumParser.RETRY)
                self.state = 438
                self.terminator(0)
                pass
            elif token in [CorundumParser.BREAK]:
                self.state = 439
    ...
    def assignment(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << CorundumParser.PLUS_ASSIGN) | (1 << CorundumParser.MINUS_ASSIGN) | (1 << CorundumParser.MUL_ASSIGN) | (1 << CorundumParser.DIV_ASSIGN) | (1 << CorundumParser.MOD_ASSIGN) | (1 << CorundumParser.EXP_ASSIGN))) != 0)):
    ...
    def array_selector(self):
        ...
        try:
            ...
            if token in [CorundumParser.ID]:
                ...
                self.match(CorundumParser.RIGHT_SBRACKET)
                pass
            elif token in [CorundumParser.ID_GLOBAL]:
                self.enterOuterAlt(localctx, 2)
                self.state = 547
                self.id_global()
                self.state = 548
    ...
    class Dynamic_resultContext(ParserRuleContext):
        ...
        def dynamic(self):
            return self.getTypedRuleContext(CorundumParser.DynamicContext,0)
    ...
    def dynamic_result(self, _p:int=0):
        ...
        try:
            ...
            if la_ == 1:
                ...
                localctx.op = self._input.LT(1)
                _la = self._input.LA(1)
                if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << CorundumParser.MUL) | (1 << CorundumParser.DIV) | (1 << CorundumParser.MOD))) != 0)):
                    localctx.op = self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                    self.consume()
                ...
                localctx.op = self._input.LT(1)
                _la = self._input.LA(1)
                if not(_la==CorundumParser.PLUS or _la==CorundumParser.MINUS):
                    localctx.op = self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                    self.consume()
    ...
    def dynamic(self):
        ...
        localctx = CorundumParser.DynamicContext(self, self._ctx, self.state)
    ...
    def int_result(self, _p:int=0):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [CorundumParser.LEFT_RBRACKET]:
                self.state = 617
                self.match(CorundumParser.LEFT_RBRACKET)
                self.state = 618
                self.int_result(0)
                ...
                self.match(CorundumParser.RIGHT_RBRACKET)
                pass
            elif token in [CorundumParser.INT]:
                self.state = 621
                self.int_t()
                pass
            else:
    ...
    def string_result(self, _p:int=0):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [CorundumParser.LEFT_RBRACKET, CorundumParser.INT]:
                self.state = 669
                self.int_result(0)
                self.state = 670
                localctx.op = self.match(CorundumParser.MUL)
                ...
                pass
            elif token in [CorundumParser.LITERAL]:
                self.state = 673
                self.literal_t()
                pass
            else:
    ...
    def comparison(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                localctx.op = self._input.LT(1)
                _la = self._input.LA(1)
                if not((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << CorundumParser.GREATER) | (1 << CorundumParser.LESS) | (1 << CorundumParser.LESS_EQUAL) | (1 << CorundumParser.GREATER_EQUAL))) != 0)):
                    localctx.op = self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                    self.consume()
                ...
                localctx.op = self._input.LT(1)
                _la = self._input.LA(1)
                if not(_la==CorundumParser.EQUAL or _la==CorundumParser.NOT_EQUAL):
                    localctx.op = self._errHandler.recoverInline(self)
                else:
                    self._errHandler.reportMatch(self)
                    self.consume()
    ...
    def rvalue(self, _p:int=0):
        ...
        try:
            ...
            if la_ == 1:
                ...
                self.state = 747
                _la = self._input.LA(1)
                if not(_la==CorundumParser.BIT_NOT or _la==CorundumParser.NOT):
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        ...
                        self.state = 765
                        _la = self._input.LA(1)
                        if not(_la==CorundumParser.BIT_SHL or _la==CorundumParser.BIT_SHR):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            self.consume()
                        ...
                        self.state = 771
                        _la = self._input.LA(1)
                        if not(_la==CorundumParser.BIT_OR or _la==CorundumParser.BIT_XOR):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            self.consume()
                        ...
                        self.state = 780
                        _la = self._input.LA(1)
                        if not(_la==CorundumParser.AND or _la==CorundumParser.OR):
                            self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            self.consume()
    ...
    def bool_t(self):
        ...
        try:
            ...
            self.state = 795
            _la = self._input.LA(1)
            if not(_la==CorundumParser.TRUE or _la==CorundumParser.FALSE):
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    def id(self):
        ...
        localctx = CorundumParser.IdContext(self, self._ctx, self.state)
    ...
    def terminator(self, _p:int=0):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [CorundumParser.SEMICOLON]:
                self.state = 806
                self.match(CorundumParser.SEMICOLON)
                pass
            elif token in [CorundumParser.CRLF]:
                self.state = 807
                self.crlf()
                pass
            else:
